...
q1 = 8  # Number of polygons around some points
q2 = 6  # Number of polygons around other points
depth = 8  # How far from the center to draw tiles
...
def draw_tiles(drawing, tiles):
    # Draw the tiles themselves (white fill, default border)
    for tile in tiles:
        tile.decorator = None
        d.draw(tile, hwidth=0.02, fill='grey')
...
d.save_svg('isosceles-{}-{}.svg'.format(q1, q2))
